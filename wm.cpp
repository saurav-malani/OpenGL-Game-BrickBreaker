...
void WindowManager::setMouseCallback(GLFWcursorposfun keyboardCallbackFunc, GLFWmousebuttonfun mouseCallbackFunc, GLFWscrollfun scrollCallbackFunc)
{
	glfwSetCursorPosCallback(this->window, keyboardCallbackFunc);
